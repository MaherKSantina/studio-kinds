...
The check is `python/studio_kinds/kinds/middleware.py` in the studio-kinds repository; the account below is the Studio's engine's own (`packages/filekinds/src/lib/middlewareDoc.ts`), which the check reproduces.
